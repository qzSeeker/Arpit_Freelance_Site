            ...
            {services.map((service, index) => (
                ...
                <div className="flex flex-col md:flex-row items-center justify-between pt-6 border-t border-neutral-800">
                    ...
                    <motion.button 
                        ...
                        className='mt-6 md:mt-0 px-6 py-2.5 rounded-lg bg-[#0d0d0d] dark:bg-[#ededed] text-[#ededed] dark:text-[#0d0d0d] font-medium text-sm hover:opacity-90 transition-opacity duration-200'>
                            Get Started
                    </motion.button>
                </div>
                </motion.div>
